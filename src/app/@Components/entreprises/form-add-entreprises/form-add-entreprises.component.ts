...
@Component({
  selector: 'app-form-add-entreprises',
  templateUrl: './form-add-entreprises.component.html'

})
export class FormAddEntreprisesComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<FormAddEntreprisesComponent>) {}
