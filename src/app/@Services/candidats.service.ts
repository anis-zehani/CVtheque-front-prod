...
export class CandidatsService {
  ...
  private serviceUrl = environment.baseUrl + '/gateway/candidat';
  ...
  addCandidatsToOpportuniteService(idOpportunite, listeCandidats, withDeletion): Observable<any> {
    return this.http.post<any>(this.serviceUrl + '/addCandidatsToOpportunite/' + idOpportunite + '/' + withDeletion,
    JSON.stringify(listeCandidats), this.httpOptions);
  }
  ...
  deleteLinkCandidatOpportuniteService(idCandidat, idOpportunite) {
      return this.http.delete<any>(this.serviceUrl + '/deleteLinkCandidatOpportunite/' + idCandidat +
  ...
  deleteLinkCandidatTechnologieService(idCandidat, idTechnologie) {
      return this.http.delete<any>(this.serviceUrl + '/deleteLinkCandidatTechnologie/' + idCandidat +
      '/' + idTechnologie, this.httpOptions);
  }
